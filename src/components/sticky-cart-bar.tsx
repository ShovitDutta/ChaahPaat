...
// Define the same palette used in other components
const palette = {
  bg: "#FFFFFF",
  card: "#E8F5E0",
  squircle: "#D9F0CC",
...
export const StickyCartBar = () => {
  ...
  const cartTotal = items.reduce((total, item) => total + (item.quantity), 0); // Simple total for now
      ...
      >
        ...
        >
          <div className="flex justify-between items-center mb-3">
            ...
            <button
              onClick={() => setStickyBarOpen(false)}
