...
export function Story() {
    return (
        <Squircle className="mx-auto max-w-7xl" innerClassName="grid md:grid-cols-2 gap-6 sm:gap-8 lg:gap-10" ariaLabel="about" id="about">
...
export function OurStory() {
    return (
        <Squircle className="mx-auto max-w-7xl" innerClassName="space-y-4 sm:space-y-5" ariaLabel="story" id="story">
            <motion.div className="space-y-3 sm:space-y-4" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: false }}>
                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    <motion.div className="pt-2 sm:pt-4 text-center" whileHover={{ x: 5 }}>
